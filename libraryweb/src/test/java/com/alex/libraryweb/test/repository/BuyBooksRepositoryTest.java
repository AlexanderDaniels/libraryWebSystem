...
import com.alex.libraryweb.domain.BuyBooks;
import com.alex.libraryweb.repository.BuyBooksRepository;
import static com.alex.libraryweb.test.repository.BooksRepositoryTest.ctx;
 ...
 * @author Alex
 */
public class BuyBooksRepositoryTest {
    
    public static ApplicationContext ctx;
    private final Long id = 1L;
    
    private BuyBooksRepository repo; 
    
    public BuyBooksRepositoryTest() {
    }
    ...
    public void createBuyBooks() {
        ...
        BuyBooks buyBooks = new BuyBooks.BuyBooksBuilder(id)
                .bookPrice(200.00)
                .build();              
